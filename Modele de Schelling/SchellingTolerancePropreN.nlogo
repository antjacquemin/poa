...
to update-tolerance
   ifelse (config-dynamique = "tolérance forcée")[
     ask turtles [
       ifelse (satisfied?)
         [ set temps-attente 0]
 ...
 [ ifelse (config-dynamique = "tolérance anti-monopole")[
     ask turtles with [not satisfied?] [
       foreach couleurs [
...
config-dynamique
config-dynamique
"tolérance forcée" "tolérance anti-monopole" "tolérances croissantes inverses"
0
